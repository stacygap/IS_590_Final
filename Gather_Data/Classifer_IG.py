...
gram = (1,1)
n = 500
Y,simple,tfidf,word = feature_selection2(df, l, mi, ma, gram, n)
output = output.append(train_model(Y,tfidf,word, 1, "tree", l, mi, ma, gram, n))
output = output.append(train_model(Y,tfidf,word, 1, "gnb", l, mi, ma, gram, n))
output = output.append(train_model(Y,simple,word, 0, "tree", l, mi, ma, gram, n))
output = output.append(train_model(Y,simple,word, 0, "gnb", l, mi, ma, gram, n))
output.to_csv("/home/zhenzuo2/project-stat/text/result3.csv", index=False)
